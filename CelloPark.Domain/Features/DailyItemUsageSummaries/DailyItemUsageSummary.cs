...
using CelloPark.Domain.Features.DailyItemUsageSummaries.Constants;
...
namespace CelloPark.Domain.Features.DailyItemUsageSummaries;

public sealed class DailyItemUsageSummary :
    IStatusOwner
{
    private DailyItemUsageSummary() { }
    ...
    public static ErrorOr<DailyItemUsageSummary> Create(
        long itemId,
        DateTime date,
        decimal gross,
        decimal cost,
        ...
        int customerCount)
    {
        ErrorOr<long> itemIdResult = ValidateItemId(itemId);
        ...
        return new DailyItemUsageSummary(
    ...
    private static ErrorOr<long> ValidateItemId(long itemId)
    {
        return itemId;
    }
    ...
    private static ErrorOr<DateTime> ValidateDate(DateTime date)
    {
        ...
        {
            return DailyItemUsageSummaryErrors.DateIsInvalid;
        }
    ...
    {
        if (gross < DailyItemUsageSummarySettings.GrossMinValue)
        {
            return DailyItemUsageSummaryErrors.GrossIsTooSmall;
        }
    ...
    private static ErrorOr<decimal> ValidateCost(decimal cost)
    {
        ...
        {
            return DailyItemUsageSummaryErrors.CostIsTooSmall;
        }
    ...
    private static ErrorOr<decimal> ValidateBenefitCost(decimal benefitCost)
    {
        ...
        {
            return DailyItemUsageSummaryErrors.BenefitCostIsTooSmall;
        }
    ...
    private static ErrorOr<int> ValidateBenefitQuantity(int benefitQuantity)
    {
        ...
        {
            return DailyItemUsageSummaryErrors.BenefitQuantityIsTooSmall;
        }
